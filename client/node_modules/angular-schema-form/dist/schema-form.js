      ...
      if (args.form.condition) {
        ...
        if (args.form.key) {
          ...
          evalExpr = 'evalExpr(' + args.path + '.condition,{ model: model, "arrayIndex": $index, ' +
                     ' arrayModel: model' + (strKey[0] === '[' ? '' : '.')+ strKey.substr(0,strKey.lastIndexOf('[')) +','+
              ...
              if (form) {
                ...
                templatePromise.then(function(template) {
                  ...
                  if (form.condition) {
                    ...
                    if (form.key) {
                      var strKey = sfPath.stringify(form.key);
                      evalExpr = 'evalExpr(form.condition,{ model: model, "arrayIndex": arrayIndex, "modelValue": model' + strKey +' ,arrayModel: model' + (strKey[0] === '[' ? '' : '.')+ strKey.substr(0,strKey.lastIndexOf('[')) + '})';
                    }
